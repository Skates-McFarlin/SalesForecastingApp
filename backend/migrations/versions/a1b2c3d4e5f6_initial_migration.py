...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('lead_time_p90_days', sa.Integer(), nullable=True),
        ...
        sa.Column('fba_storage_fee_monthly', sa.Float(), nullable=True),
        sa.Column('item_volume_cuft', sa.Float(), nullable=True),
        sa.Column('units_aged', sa.Integer(), nullable=True),
        sa.Column('created_at', sa.DateTime(), nullable=True),
